  ...
  return (
    <>
      ...
      <header className="bg-[#232338] md:w-[1440px] md:h-[880px]   ">
        ...
        {/* button */}
        <button className="absolute md:w-[154px] md:h-[48px] md:left-[135px] md:top-[608px]  border rounded-[8px] bg-[#ef6d58] text-white font-black text-sm leading-[100%] text-center uppercase font-epilogue">
          HOW WE WORK
        </button>
          ...
          <div>
            <div className="absolute md:w-[570px] md:h-[368px] md:top-[2848px] md:left-[135px] rounded-[6px] bg-[#9b9b9b]">
              ...
              <div className="absolute md:w-[148px] md:h-[148px] md:top-[110px] md:left-[210px]">
                <button className="absolute md:w-[148px] md:h-[148px] rounded-full border-[1px] border-[#ffffff] flex items-center justify-center">
                  <div className="w-0 h-0 border-l-[16px] border-r-[16px] border-b-[22px] border-l-transparent border-r-transparent border-b-white rotate-[90deg] rounded-[2px]"></div>
                </button>
              </div>
